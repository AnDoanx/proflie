...
<?php 
$𝙠𝙝𝙤𝙖𝙖𝙣𝙣Header = new ThanhDieuHeader();
$𝙠𝙝𝙤𝙖𝙖𝙣𝙣LoveDays = new ThanhDieuLoveDays();
$𝙠𝙝𝙤𝙖𝙖𝙣𝙣MusicList = new ThanhDieuMusicList();
$𝙠𝙝𝙤𝙖𝙖𝙣𝙣Header->CommonMethod();
$𝙠𝙝𝙤𝙖𝙖𝙣𝙣LoveDays->CommonMethod();
$𝙠𝙝𝙤𝙖𝙖𝙣𝙣MusicList->CommonMethod();
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta name="description" content="<?=$𝙠𝙝𝙤𝙖𝙖𝙣𝙣->description?>">
    <meta name="author" content="ThanhDieuTV">
    <meta name="keywords"
        content="<?=$𝙠𝙝𝙤𝙖𝙖𝙣𝙣->keywords?>">
    <meta name="robots" content="index, follow">
    <meta property="og:type" content="website">
    <link rel="shortcut icon" href="<?=$𝙠𝙝𝙤𝙖𝙖𝙣𝙣->favicon?>?v=<?=rand(1,999)?>" type="image/x-icon">
    <meta property="og:title" content="<?=$𝙠𝙝𝙤𝙖𝙖𝙣𝙣->title?>">
    <meta property="og:url" content="//thanhdieu.com">
    <meta property="og:image" content="./res/v5/img/bg3.webp">
    <title><?=$𝙠𝙝𝙤𝙖𝙖𝙣𝙣->title?></title>
    <!--/ @StyleSheets /-->
...
<body class="BodyStyle">
    ...
    <div id="loading-box">
        <div class="loading-bg">
            <img class="loading-img entered loading" src="<?=$khoaann->favicon?>?v=<?=rand(1,999)?>" data-ws-status="loading">
    ...
    <main id="td-main">
            ...
            <div class="td-popup" id="share_card">
                <div class="left">
                    ...
                    <div class="button mt-2">
                        ...
                        <span class="td-btn"
                            onclick="window.open('https://www.messenger.com/t/' + encodeURIComponent('wuskhoaan'),'top');"
        ...
        <header id="header">
            <h2>
                <a href="#" class="site-icon"><?=$khoaann->namesite?></a>
            </h2>
        ...
        <section class="td-content">
            <div class="about-me">
                <div class="info-left">
                    <span class="tag"><?=$khoaann->bio1?></span>
                    <span class="tag"><?=$khoaann->bio2?></span>
                    <span class="tag"><?=$khoaann->bio3?></span>
                </div>
                <div class="avatar">
                    <img class="avatar-img" src="<?=$khoaann->avatar?>?v=<?=rand(1,999)?>" alt="Vương Thanh Diệu">
                    <img class="crown" src="./res/v5/img/crown/mong-vuot-rong.png">
                    <!-- <img class="crown2" src="./res/v5/img/crown/vip-crown.png"> -->
                </div>
                <div class="info-right">
                    <span class="tag"><?=$khoaann->bio4?></span>
                    <span class="tag"><?=$khoaann->bio5?></span>
                    <span class="tag"><?=$khoaann->bio6?></span>
                </div>
            </div>
            <div class="padding" style="height:2em;"></div>
            <h2 class="HoVaTen__">
                <span id="userName" data-userName='<?= json_encode($khoaann->userName ?? []) ?>'></span>
            </h2>
            <div class="about-me-2">
                <button class="trigger"><?=$khoaann->trigger?></button>
                <button class="trigger"><?=$khoaann->bio1?></button>
                <button class="trigger"><?=$khoaann->bio2?></button>
                <button class="trigger"><?=$khoaann->bio3?></button>
                <button class="trigger"><?=$khoaann->bio4?></button>
                <button class="trigger"><?=$khoaann->bio5?></button>
                <button class="trigger"><?=$khoaann->bio6?></button>
            </div>
            <div class="padding" style="height:1em;"></div>
            <section id="hr-mod">
                <?php foreach ($khoaann->SocialNetworks as $network => $url): ?>
    ...
    <div class="padding" style="height:4em;"></div>
        <div class="love-time1 mt-5">
            <div class="hide" data-ngayyeu="<?= $𝙠𝙝𝙤𝙖𝙖𝙣𝙣LoveDays->ConfigLove['time_relashiption']; ?>"></div>
        ...
        <div class="bg-wrap central mt-5">
            <div class="bg-img">
                <div class="middle animated">
                    <div class="img-male">
                        <img src="<?=$𝙠𝙝𝙤𝙖𝙖𝙣𝙣LoveDays->ConfigLove['avatar_male'];?>"
                            alt="<?=$𝙠𝙝𝙤𝙖𝙖𝙣𝙣LoveDays->ConfigLove['name_male'];?>">
                        <img class="crown-love" src="./res/v5/img/crown/khung-4.png">
                        <span><?=$𝙠𝙝𝙤𝙖𝙖𝙣𝙣LoveDays->ConfigLove['name_male'];?></span>
                    </div>
                    <div class="heart"></div>
                    <div class="img-female">
                        <img src="<?=$𝙠𝙝𝙤𝙖𝙖𝙣𝙣LoveDays->ConfigLove['avatar_female'];?>"
                            alt="<?=$𝙠𝙝𝙤𝙖𝙖𝙣𝙣LoveDays->ConfigLove['name_female'];?>">
                        <img class="crown-love" src="./res/v5/img/crown/khung-4.png">
                        <span><?=$𝙠𝙝𝙤𝙖𝙖𝙣𝙣LoveDays->ConfigLove['name_female'];?></span>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="nk-opt-set">
                                ...
                                <div class="nk-opt-list">
                                    <ul class="music_menu_list">
                                        <?php foreach ($KhoaAnMusicList->songs as $song): ?>
                                        <li url="<?= $song['url'] ?>">
                                            <span class="name">
